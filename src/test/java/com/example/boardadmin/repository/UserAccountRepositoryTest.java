...
class JpaRepositoryTest {
    ...
    void givenUserAccount_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = UserAccount.of("test", "pw", Set.of(RoleType.DEVELOPER), "email", "test", null);
        //When
    ...
    void givenUserAccountAndRoleType_whenUpdating_thenWorksFine() {
        //Given
        UserAccount userAccount = userAccountRepository.getReferenceById("inderby");
